...
export const DOMAIN_MICROSERVICES = 'https://apimocha.com/msdev/';

export const ENDPOINTS_MICROSERVICES = {
    MS_MAESTROS: `${DOMAIN_MICROSERVICES}msmaestros/`,
    MS_PERSONA: `${DOMAIN_MICROSERVICES}mspersona/`,
    MS_MESA: `${DOMAIN_MICROSERVICES}msmesa/`,
};
