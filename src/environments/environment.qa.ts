...
export const ENDPOINTS_MICROSERVICES = {
    ...
    MS_MAESTROS: `http://cfms-generales-maestros-gestion-api-qa.apps.ocp4.cfe.mpfn.gob.pe/cfe/generales/maestro/v1/`,
    MS_PERSONA: `http://cfms-generales-persona-cliente-api-qa.apps.ocp4.cfe.mpfn.gob.pe/cfe/generales/persona/v1/`,
